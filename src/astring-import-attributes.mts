...
interface ImportDeclarationWithAttributes extends ImportDeclaration {
  attributes: ImportAttribute[];
}

function isImportDeclarationWithAttributes (node: Node): node is ImportDeclarationWithAttributes {
  return node.type === 'ImportDeclaration' && Object.hasOwn(node, 'attributes');
}

export function astringImportAttributes (generator?: Generator): Generator {
  return Object.assign({}, generator, {
    // based on current ImportDeclaration implementation
    // https://github.com/davidbonnet/astring/blob/main/src/astring.js#L539-L587
